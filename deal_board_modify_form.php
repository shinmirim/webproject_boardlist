...
?>
	    <form  name="board_form" method="post" action="deal_board_modify.php?num=<?=$num?>&page=<?=$page?>" enctype="multipart/form-data">
	    	 <ul id="board_form">
				<li>
				...
				<li>
	    			...
	    			<span class="col2"><input name="productname" type="text" value="<?=$productname?>"></span>
	    		</li>	    	
				<li>
	    			<span class="col1">정가 : </span>
	    			<span class="col2"><input name="realprice" type="number" value="<?=$realprice?>"></span>
	    		</li>	    	
				<li>
	    			<span class="col1">판매가 : </span>
	    			<span class="col2"><input name="sellprice" type="number" value="<?=$sellprice?>"></span>
	    		</li>	    		    		
	    		<li id="text_area">	
